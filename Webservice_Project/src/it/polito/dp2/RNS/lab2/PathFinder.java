...
public interface PathFinder {
	 ...
	 * @throws ModelException if the operation cannot be completed because the current model cannot be read or is wrong 
	 * (the problem is not related to the remote service)
	 */
